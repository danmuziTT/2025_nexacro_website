            				...
            				"parent" :
            				{
            					...
            					"MultiCombo" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_Dropbtn.png')")
            							},
            							"mouseover" :
            							{
            								"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_Dropbtn.png')")
            						...
            						[
            							{
            								"mcbo_WF_Count" :
            								{
            									"self" :
            									{
            										"enabled" :
            										{
            											"border" : nexacro.BorderObject("0px none,1px solid #919396,1px solid #919396,0px none")
            										}
            									}
            								}
            							}
            								...
            								"parent" :
            								{
            									"MultiCombo" :
            									{
            										"self" :
            										{
            											...
            											"mouseover" :
            											{
            												"color" : nexacro.ColorObject("#5eb7ff")
            											},
            											"selected" :
            											{
            											...
            											"readonly" :
            											{
            												"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_ChksetRead.png')"),
            												"color" : nexacro.ColorObject("#919396")
            											}
            										}
            									},
            						...
            						[
            							{
            								"mcbo_WF_Count" :
            								{
            									"self" :
            									{
            										"enabled" :
            										{
            											"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #919396, 1px solid #919396")
            										}
            									}
            								}
            							}
            						...
            						[
            							{
            								"mcbo_WF_Count" :
            								{
            									"self" :
            									{
            										"enabled" :
            										{
            											"border" : nexacro.BorderObject("1px solid #919396, 1px solid #919396, 1px solid #c4c4c4, 1px solid #919396")
            										}
            									}
            								}
            							}
