(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_url("Exe2::Exe2_Chap3_Div_PopupDiv_Sub.xfdl");
            obj.set_text("");
            obj.set_border("1px solid darkgray");
            this.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","Exe2::Exe2_Chap3_Div_PopupDiv_Sub.xfdl");
        };
        ...
        this.btn_Exe1_1_onclick = function(obj,e)
        {
           var nX = 0;
           var nY = obj.height;
           this.PopupDiv1.trackPopupByComponent(obj, nX, nY); // obj(btn, Exe1_1)를 중심으로 0, obj(버튼) 높이 아래에 표시
        };
        ...
        this.btn_Exe2_1_onclick = function(obj,e)
        {
           var nX = 0;
           var nY = obj.height;
           this.PopupDiv2.trackPopupByComponent(obj, nX, nY, null, null, "fn_popupCallback");
        };
        ...
        this.fn_popupCallback = function(objId, rtn) {
           ...
           if (objId == "PopupDiv2") {
              this.edt_dept2.set_value(rtn[0]);
              this.edt_name2.set_value(rtn[1]);
              this.edt_id2.set_value(rtn[2]);
           }
        };

        this.PopupDiv1_btn_Exe1_Close_onclick = function(obj,e)
        {
        // 버튼을 클릭하여 값 전달 후 창 닫기
        //    var nRow = this.Dataset1.rowposition
        //    var sDept = this.Dataset1.getColumn(nRow, "DEPT_NAME");
        //    var sName = this.Dataset1.getColumn(nRow, "FULL_NAME");
        //    var sEmp = this.Dataset1.getColumn(nRow, "EMPL_ID");
        //
        //    this.edt_dept.set_value(sDept);
        //    this.edt_name.set_value(sName);
        //    this.edt_id.set_value(sEmp);

        // 각각의 edit에 데이터베이스 바인딩
