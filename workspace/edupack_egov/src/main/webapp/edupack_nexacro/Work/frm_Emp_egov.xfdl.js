(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1290,720);
            }
            ...
            obj = new Grid("grd00","20","115","860","569",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Div("div01","949","105","321","550",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_border("1px solid");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","-50","20","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("0");
            obj.set_text("성명");
            this.div01.addChild(obj.name, obj);

            obj = new Edit("edt00","65","13","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("1");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta01","-50","73","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("2");
            obj.set_text("사원번호");
            this.div01.addChild(obj.name, obj);

            obj = new MaskEdit("msk00","65","69","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("3");
            obj.set_type("string");
            obj.set_format("AA-###");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta02","-50","123","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("4");
            obj.set_text("부서");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta03","-50","173","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("5");
            obj.set_text("직급");
            this.div01.addChild(obj.name, obj);

            obj = new Combo("cbo00","65","126","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("6");
            ...
            obj = new Static("sta04","-50","256","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("7");
            obj.set_text("성별");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta05","-50","316","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("8");
            obj.set_text("결혼여부");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta06","-50","363","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("9");
            obj.set_text("입사일");
            this.div01.addChild(obj.name, obj);

            obj = new ListBox("lst00","65","178","251","72",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("10");
            ...
            obj = new Radio("rdo00","65","255","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("11");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new CheckBox("chk00","65","301","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("12");
            obj.set_text("결혼했음");
            this.div01.addChild(obj.name, obj);

            obj = new Calendar("cal00","1","351","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("13");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta07","-50","420","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("14");
            obj.set_text("급여");
            this.div01.addChild(obj.name, obj);

            obj = new MaskEdit("msk01","65","422","251","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("15");
            obj.set_format("#,###");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta08","-50","474","120","26",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("16");
            obj.set_text("비고사항");
            this.div01.addChild(obj.name, obj);

            obj = new TextArea("txt00","65","468","251","73",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("17");
            this.div01.addChild(obj.name, obj);

            obj = new Calendar("cal01","165","301","151","35",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("18");
            obj.set_visible("true");
            this.div01.addChild(obj.name, obj);

            obj = new Button("btn00","127","20","107","20",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("사원조회");
            this.addChild(obj.name, obj);

            obj = new Edit("edtDept","630","10","118","27",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);

            obj = new Static("sta01","570","12","57","22",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("부서");
            this.addChild(obj.name, obj);

            obj = new Button("btn01","249","20","111","20",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("부서코드 전달");
            this.addChild(obj.name, obj);

            obj = new Static("sta02","778","10","120","26",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("성명");
            this.addChild(obj.name, obj);

            obj = new Edit("edtName","819","6","98","28",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            this.addChild(obj.name, obj);

            obj = new Button("btn02","375","17","125","23",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("부서+성명 전달");
            this.addChild(obj.name, obj);

            obj = new Grid("grd01","990","16","276","68",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_binddataset("dsSerach");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"135\"/><Column size=\"135\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"COL_DEPT\"/><Cell col=\"1\" text=\"COL_NAME\"/></Band><Band id=\"body\"><Cell text=\"bind:COL_DEPT\"/><Cell col=\"1\" text=\"bind:COL_NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn03","740","50","126","31",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("데이터셋 전달");
            this.addChild(obj.name, obj);

            obj = new Button("btn04","828","110","109","34",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("트렌잭션1");
            this.addChild(obj.name, obj);

            obj = new MaskEdit("mskId","756","300","179","40",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_type("string");
            obj.set_format("AA-####");
            this.addChild(obj.name, obj);

            obj = new Button("btn05","838","238","90","29",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("중복체크");
            this.addChild(obj.name, obj);

            obj = new Button("btnAdd","100","447","120","26",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("추가");
            this.addChild(obj.name, obj);

            obj = new Button("btnDelete","230","447","120","26",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new Button("btnSave","360","447","120","26",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("저장");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1290,720,this,function(p){});
            ...
            obj = new BindItem("item11","edtDept","value","dsSerach","COL_DEPT");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","edtName","value","dsSerach","COL_NAME");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("frm_Emp_egov.xfdl", function() {
        ...
        {
        	this.transaction("getEmpListparam1"
        					,"SvcUrl::edu/getEmpListParam1.do"
        					,""
        					,"ds_emp=out_emp"
        					,"pDept=" + this.edtDept.value //공백문자 들어가면 안됨
        					,"");
        };

        this.btn02_onclick = function(obj,e)
        {
        	this.transaction("getEmpListparam2"
        					,"SvcUrl::edu/getEmpListParam2.do"
        					,""
        					,"ds_emp = out_emp"
        					,"pDept=" + this.edtDept.value + " pName=" + this.edtName.value
        					,"");
        };

        this.btn03_onclick = function(obj,e)
        {
        	this.transaction("getEmpListparamDs"
        ...
        {
        	this.transaction("getCodeList"
        					,"SvcUrl::edu/getCodeList.do"
        					,""
        ...
        {
        	this.transaction("chechId"
        					,"SvcUrl::edu/chechId.do"
        					,""
        					,""
        					,"paramId=" + this.mskId.value
        					,"fn_callback");
        };
        ...
        this.loadIncludeScript("frm_Emp_egov.xfdl");
