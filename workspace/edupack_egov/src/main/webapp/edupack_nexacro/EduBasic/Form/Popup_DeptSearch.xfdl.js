(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static00","10","10","193","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("부서 검색");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"185\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Dept Code\"/><Cell col=\"1\" text=\"Dept Name\"/></Band><Band id=\"body\"><Cell text=\"bind:DEPT_CD\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:DEPT_NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_ok","75",null,"70","26",null,"10",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("OK");
            this.addChild(obj.name, obj);

            obj = new Button("btn_cancel","155",null,"70","26",null,"10",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Cancel");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        {
        	this.transaction("svcDeptSearch"
        				    ,"SvcUrl::select_tbn_dept.jsp"
        					,""
        					,"ds_dept=out_dept"
        					,""
        					,"fn_callback");
