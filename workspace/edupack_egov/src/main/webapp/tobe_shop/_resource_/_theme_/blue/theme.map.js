(function()
{
	return function()
	{
            ...
            "Form" :
            			...
            			"Button" :
            			{
            				"self" :
            				{
            					...
            					{
            						"border" : nexacro.BorderObject("0px none"),
            						"font" : nexacro.FontObject("16pt \"Verdana\""),
            				...
            				[
            					{
            						"top_Button" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("20pt \"LG Smart UI Bold\""),
            									"border" : nexacro.BorderObject("0px none")
            								},
            								"mouseover" :
            								{
            					...
            					},
            					{
            						"WF_loginSellerCenter" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("20pt \"Verdana\"")
            								}
            							}
            						}
            					},
            					{
            						"TF_miniBtn" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("bold 20px \"Verdana\""),
            								...
            								{
            									"border" : nexacro.BorderObject("0px solid"),
            									"color" : nexacro.ColorObject("#565656")
            								},
            								"focused_pushed" :
            								{
            									"border" : nexacro.BorderObject("0px solid")
            				...
            				[
            					{
            						"pro_oneOption" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("20px \"Verdana\"")
            								}
            							}
            						}
            					}
            				...
            				[
            					{
            						"register_Edt" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("15pt \"Verdana\"")
            								}
            							}
            						}
            					}
            				...
            				[
            					{
            						"WF_mainWelcome" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("24pt \"Arial\"")
            								}
            							}
            						}
            					},
            					{
            						"WF_mainExplain" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("15pt \"Arial\"")
            								}
            							}
            						}
            					},
            					{
            						"WF_loginTitle" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("36pt \"Verdana\"")
            								}
            							}
            						}
            					},
            					{
            						"WF_loginText" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("18pt \"Verdana\"")
            								}
            							}
            						}
            					},
            					{
            						"pro_oneTitle" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("bold 30pt/normal \"Verdana\"")
            								}
            							}
            						}
            					},
            					{
            						"pro_onePrice" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("bold 20pt/normal \"Verdana\"")
            								}
            							}
            						}
            					}
        ...
        imgcache[nexacro._getImageLocation("theme://images/background.jpg")] = { width:5000, height:7000 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/tobe_sellerCenter.png")] = { width:457, height:109 };
        		imgcache[nexacro._getImageLocation("theme://images/bell.png")] = { width:318, height:355 };
        		imgcache[nexacro._getImageLocation("theme://images/btn_WF_Popupexpand.png")] = { width:3, height:5 };
        		imgcache[nexacro._getImageLocation("theme://images/buy1.png")] = { width:144, height:300 };
        		imgcache[nexacro._getImageLocation("theme://images/buy2.png")] = { width:542, height:1130 };
        		imgcache[nexacro._getImageLocation("theme://images/cart.png")] = { width:385, height:361 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/like.png")] = { width:348, height:343 };
        		imgcache[nexacro._getImageLocation("theme://images/likeHerat_off.png")] = { width:50, height:50 };
        		imgcache[nexacro._getImageLocation("theme://images/likeHerat_on.png")] = { width:50, height:50 };
        		imgcache[nexacro._getImageLocation("theme://images/Logo .png")] = { width:500, height:201 };
        		imgcache[nexacro._getImageLocation("theme://images/mnu_WF_PopItemImg.png")] = { width:8, height:7 };
        		imgcache[nexacro._getImageLocation("theme://images/party_cracker_kamifubuki.png")] = { width:738, height:738 };
        		imgcache[nexacro._getImageLocation("theme://images/pro.png")] = { width:656, height:800 };
        		imgcache[nexacro._getImageLocation("theme://images/random.png")] = { width:287, height:400 };
        		imgcache[nexacro._getImageLocation("theme://images/searchLogo.png")] = { width:415, height:407 };
        		imgcache[nexacro._getImageLocation("theme://images/sell.png")] = { width:800, height:422 };
        		imgcache[nexacro._getImageLocation("theme://images/sellerLogo.png")] = { width:500, height:163 };
        		imgcache[nexacro._getImageLocation("theme://images/takuhai_daibiki_card.png")] = { width:310, height:305 };
	};
}
)();
