(function()
{
	return function()
	{
            						...
            						"sta_WF_LabelTxt12" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#212d9b"),
            									"letterSpacing" : nexacro.CSSValueObject("0px")
            								}
            							}
            						}
            				...
            				"parent" :
            				{
            					"CheckBoxSet" :
            					{
            						"self" :
            						{
            							...
            							"readonly" :
            							{
            								"icon" : nexacro.UrlObject("url('theme://images/chks_WF_ItemRead.png')"),
            						...
            						"parent" :
            						{
            							"MultiComboListControl" :
            							{
            								"self" :
            								{
            									"enabled" :
            									{
            										"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_ChkItem.png')"),
            									...
            									"readonly" :
            									{
            										"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_ChkItemR.png')"),
            										"color" : nexacro.ColorObject("#888888")
            									},
            									"selected" :
            									{
            										"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_ChkItemS.png')"),
            				...
            				"parent" :
            				{
            					"MultiComboListControl" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_ChkAllItem.png')"),
            								"textPadding" : nexacro.PaddingObject("0px 0px 0px 10px"),
            								"padding" : nexacro.PaddingObject("8px"),
            								"font" : nexacro.FontObject("13px \"Verdana\", \"Malgun Gothic\"")
            							},
            							...
            							"selected" :
            							{
            								"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_ChkAllItemS.png')"),
            								"color" : nexacro.ColorObject("#ffffff")
            							}
            						}
            					}
            								...
            								"parent" :
            								{
            									"MultiCombo" :
            									{
            										"self" :
            										{
            											"enabled" :
            											{
            												"icon" : nexacro.UrlObject("url('theme://images/mcbo_WF_Tagbtn.png')")
            											}
            										}
            									}
            								}
        ...
        imgcache[nexacro._getImageLocation("theme://images/btn_TF_MaxP.png")] = { width:11, height:11 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/chks_WF_ItemRead.png")] = { width:13, height:13 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_Drop.png")] = { width:9, height:6 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChkAllItem.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChkAllItemS.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChkItem.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChkItemR.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChkItemS.png")] = { width:15, height:15 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/KakaoTalk_20241223_155152565_22.jpg")] = { width:929, height:1440 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_Chkset.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChksetRead.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_ChksetS.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_Dropbtn.png")] = { width:9, height:6 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_SelAll.png")] = { width:17, height:17 };
        		imgcache[nexacro._getImageLocation("theme://images/mcbo_WF_SelAllS.png")] = { width:17, height:17 };
