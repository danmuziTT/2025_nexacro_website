(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("LessonJour1301.xfdl", function() {
        /**
        ...
        **************************************************************************/
        ...
        {
        	if(this.fn_ValiationCheck()  == false ) return;
        ...
        this.fn_ValiationCheck = function ()
        {
        	this.gfnClearValidation(this.dsMember);

        	//rule 등록
        	this.gfnSetValidation(this.dsMember, "USER_ID", "아이디", "required");
        	this.gfnSetValidation(this.dsMember, "USER_NAME", "성명", "required");
        	this.gfnSetValidation(this.dsMember, "USER_BIRTH", "생일", "date");

        	//rule 체크
        	this.gfnValidation(this.dsMember, "U");
        ...
        this.loadIncludeScript("LessonJour1301.xfdl");
