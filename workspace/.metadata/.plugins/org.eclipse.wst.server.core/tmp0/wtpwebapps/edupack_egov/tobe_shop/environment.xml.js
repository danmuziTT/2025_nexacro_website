if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_loadingimage("url(\'loading.gif\')");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("userInfo", "form", "./userInfo/", "session", null, "", "0", "0");
        nexacro._addService("sellerInfo", "form", "./sellerInfo/", "session", null, "", "0", "0");
        nexacro._addService("sellerForm", "form", "./sellerForm/", "session", null, "", "0", "0");
        ...
        nexacro._addService("SvcUrl", "JSP", "http://172.10.14.144:8088/edupack_egov/", "none", null, "", "0", "0");
