(function()
{
    return function()  
	{
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            frame0.set_separatesize("150,*,0");
            this.addChild(frame0.name, frame0);
            this.frame=frame0;

            var frame1 = new ChildFrame("TopMainFrame",null,null,null,null,null,null,"form::Form_Top.xfdl",frame0);
            frame1.set_showtitlebar("false");
            frame1.set_showtitleicon("false");
            frame1.set_dragmovetype("none");
            frame0.addChild(frame1.name, frame1);
            frame1.set_formurl("form::Form_Top.xfdl");


            var frame2 = new ChildFrame("UserFrame",null,null,null,null,null,null,"Base::user_form.xfdl",frame0);
            frame2.set_showtitleicon("false");
            frame2.set_showtitlebar("false");
            frame2.set_dragmovetype("none");
            frame0.addChild(frame2.name, frame2);
            frame2.set_formurl("Base::user_form.xfdl");
            ...
            var frame4 = new ChildFrame("LeftFrame",null,null,null,null,null,null,"sellerInfo::frame_left.xfdl",frame3);
            frame4.set_dragmovetype("none");
            frame4.set_showtitlebar("false");
            frame3.addChild(frame4.name, frame4);
            frame4.set_formurl("sellerInfo::frame_left.xfdl");
            ...
            var frame6 = new ChildFrame("MDIframe",null,null,null,null,null,null,"sellerInfo::frame_MDI.xfdl",frame5);
            ...
            frame6.set_formurl("sellerInfo::frame_MDI.xfdl");


            var frame7 = new FrameSet("FrameSet00",null,null,null,null,null,null,frame5);
            frame7.set_showtitlebar("false");
            frame5.addChild(frame7.name, frame7);

            var frame8 = new ChildFrame("frameMain",null,null,null,null,null,null,"sellerInfo::seller_main.xfdl",frame5);
            frame8.set_dragmovetype("none");
            frame8.set_showtitlebar("false");
            frame5.addChild(frame8.name, frame8);
            frame8.set_formurl("sellerInfo::seller_main.xfdl");
        };
